...
if n % 2 == 0:  # amount of even and odd numbers are equal
    ...
    if k > (n / 2):  # i don't need odds, just evens will do.
        print(int(2 + (k - (n / 2) - 1) * 2))  # eleminating the amount of odd values from k. for 10, odd amount of numbers are 5. eleminating 5 from 9, gives us 4, so, k = 4, 2 is one even number. That i am using manually, gives us k = 3. so, 2*3 = 6 and 6+2 = 8. Voila!
